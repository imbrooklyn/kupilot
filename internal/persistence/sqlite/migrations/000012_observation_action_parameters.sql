...
CREATE TABLE approval_decisions_v12 (
    ...
    FOREIGN KEY (approval_id) REFERENCES approvals_v12(id) ON DELETE CASCADE
) STRICT;

INSERT INTO approval_decisions_v12 (
...
CREATE TABLE action_reviews_v12 (
    ...
    FOREIGN KEY (approval_id, policy_generation)
        REFERENCES approvals_v12(id, policy_generation) ON DELETE CASCADE
) STRICT;

INSERT INTO action_reviews_v12 (
...
ALTER TABLE action_reviews_v12 RENAME TO action_reviews;
