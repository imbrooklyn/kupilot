...
CREATE TABLE approval_decisions_v11 (
    ...
    FOREIGN KEY (approval_id) REFERENCES approvals_v11(id) ON DELETE CASCADE
) STRICT;

INSERT INTO approval_decisions_v11 (
...
CREATE TABLE action_reviews_v11 (
    ...
    FOREIGN KEY (approval_id, policy_generation)
        REFERENCES approvals_v11(id, policy_generation) ON DELETE CASCADE
) STRICT;

INSERT INTO action_reviews_v11 (
...
ALTER TABLE action_reviews_v11 RENAME TO action_reviews;
