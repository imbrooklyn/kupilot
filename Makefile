...
IMPORT_GUARD_PATTERN := ^(TestApplicationImportBoundaryIsStatic|TestEinoImportsRemainInTheSoleTranslationBoundary|TestExportedKubeBoundaryContainsNoClientGoTypes|TestReadOnlyToolPathContainsNoWriteShellOrGenericKubernetesEscape|TestTUIImportBoundaryAndSingleTextareaAreStatic|TestRepositorySourcesKeepExplicitSQLBoundary|TestSQLXImportRemainsInsideSQLiteAdapter|TestCompositionConstructsOneModelLifecycleAndOneSupervisedRestartPath|TestSelectedDriverAndSQLXContract|TestProductionHasOneClosedSupervisedRestartExecutor)$$
