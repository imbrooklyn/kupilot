...
MIGRATION_TEST_PATTERN := ^(TestMigrate.*|TestReleasedMigrationMatrix.*|TestApprovalRuntimeMigration.*|TestMinimalRunIdentityMigration.*|TestMigrationTenAdmitsCompleteToolCatalog|TestInitialSchemaContainsOnlyAllowlistedStorageColumns|TestActionAuthoritySchemaContainsNoRawParameterOrTransportColumns|TestActionAuthoritySchemaChecksMirrorDomainShape)$$
