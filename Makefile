...
MIGRATION_TEST_PATTERN := ^(TestMigrate.*|TestReleasedMigrationMatrix.*|TestApprovalRuntimeMigration.*|TestMinimalRunIdentityMigration.*|TestRunConversationSequenceMigration.*|TestMigrationTenAdmitsCompleteToolCatalog|TestInitialSchemaContainsOnlyAllowlistedStorageColumns|TestActionAuthoritySchemaContainsNoRawParameterOrTransportColumns|TestActionAuthoritySchemaChecksMirrorDomainShape)$$
